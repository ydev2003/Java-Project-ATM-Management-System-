...
public class ATM extends JFrame {
	...
	public ATM(){
		...
		JButton withDraw2 = new JButton("Withdraw \u20B95000");
		bPConst.gridx = 0;
		bPConst.gridy = 1;
		withDraw2.setSize(new Dimension(200, 30));
		buttonPanel.add(withDraw2, bPConst);
		JButton withDraw3 = new JButton("Withdraw \u20B910000");
		bPConst.gridx = 0;
		bPConst.gridy = 2;
		...
		withDraw2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 5000){
					...
					displayArea.setText("<html>\u20B95000 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn  Rs5000");
					updateTransactionHist("User Has Withdrawn \u20B95000");
				} else {
					displayArea.setText("<html> Your Balance is below \u20B95000. Unable to Withdraw!! <br><br>" 
					+ finishedTransaction() + "</html>");
				}
		...
		withDraw3.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 10000){
					...
					displayArea.setText("<html>\u20B910000 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn Rs10000");
					updateTransactionHist("User Has Withdrawn \u20B910000");
				} else {
